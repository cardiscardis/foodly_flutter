...
class FoodViewRestaurants extends StatefulWidget {
  ...
  const FoodViewRestaurants({Key? key}) : super(key: key);
      ...
      appBar: appBarWidget(
        ...
        actions: [
          IconButton(
            ...
            onPressed: () {
              const PurchaseMoreScreen(true).launch(context);
            },
          ),
        ],
      ),
...
class RestaurantsInfo extends StatelessWidget {
  ...
  RestaurantsInfo(this.model, this.model1, this.pos, {Key? key}) : super(key: key);
