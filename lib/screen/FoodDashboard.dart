...
class Item extends StatelessWidget {
  ...
  Item(this.model, int pos, {Key? key}) : super(key: key);
...
class Collection extends StatelessWidget {
  ...
  Collection(this.model, int pos, {Key? key}) : super(key: key);
...
class FoodSideMenu extends StatefulWidget {
  const FoodSideMenu({Key? key}) : super(key: key);
