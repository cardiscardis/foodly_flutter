...
import 'package:foodly/utils/FoodWidget.dart';
...
class FoodBookCart extends StatefulWidget {
  ...
  const FoodBookCart({Key? key}) : super(key: key);
...
class FoodBookCartState extends State<FoodBookCart> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
                      ...
                      children: <Widget>[
                        Row(
                          ...
                          children: <Widget>[
                            ...
                            GestureDetector(
                              onTap: () {
                                const PurchaseMoreScreen(false).launch(context);
                              },
      ...
      body: const PurchaseMoreScreen(true),
    );
  }
}
...
class Cart extends StatelessWidget {
  ...
  Cart(FoodDish model, int pos, {Key? key}) : super(key: key) {
    this.model = model;
  }
